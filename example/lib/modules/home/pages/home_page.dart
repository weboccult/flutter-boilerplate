  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: aC.onLogout, icon: const Icon(Icons.logout_rounded)),
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                    onPressed: hC.goToHTTPWidgetExamplePage,
                    child: const Text('HTTP WIDGET PAGE')),
              ),
              const SizedBox(height: 20.0),
              SizedBox(
                width: double.infinity,
                height: 50.0,
                child: ElevatedButton(
                    onPressed: hC.goToStorageListenerExampleWidget,
                    child: const Text('STORAGE LISTENER WIDGET PAGE')),
              ),
              const SizedBox(height: 20.0),
              SizedBox(
                width: double.infinity,
                height: 50.0,
                child: ElevatedButton(
                    onPressed: hC.goToCombinedHttpAndStorageListenerWidget,
                    child: const Text('BOTH ABOVE COMBINED PAGE')),
              ),
            ],
          ),
        ));
