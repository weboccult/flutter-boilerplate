...
abstract class Routes {
  ...
  static const COMBINED_HTTP_WIDGET_AND_STORAGE_LISTENR_WIDGET_EXAMPLE_PAGE =
      '/combined_storage_listener_and_http_widget_example_page';
}
...
abstract class RouteServices {
  ...
  static Map<String, Widget Function(BuildContext context)> routes = {
    ...
    Routes.STORAGE_LISTENER_EXAMPLE_PAGE: (context) =>
        const StorageListenerWidgetExample(),
    Routes.COMBINED_HTTP_WIDGET_AND_STORAGE_LISTENR_WIDGET_EXAMPLE_PAGE:
        (context) => const CombinedHttpAndStorageListenerExample(),
  };
