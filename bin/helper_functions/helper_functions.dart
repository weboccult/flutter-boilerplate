...
*
* */
  static Future<void> get initRequiredDependenciesToProject =>
      _initRequiredDependencies();
  static _initRequiredDependencies() async {
    ...
    await _updateYAMLFilesToProject(
...
*
* */
  static Future<void> get baseProjectStructureInit =>
      _createBaseProjectStructure();
  static _createBaseProjectStructure() async {
    Uri? baseAppFolder = await Isolate.resolvePackageUri(
        Uri(scheme: 'package', path: 'flutter_boilerplate/app/'));
  ...
  static _updateYAMLFilesToProject(String fileName) async {
    Uri? fileUri = await Isolate.resolvePackageUri(Uri(
        scheme: 'package', path: 'flutter_boilerplate/yaml_file/$fileName'));
